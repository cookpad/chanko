= Chanko
== What is Chanko
Chanko is a simple way to rapidly and safely add prototype features to your
production site, and expose these prototypes to segments of your user base.
Chanko was extracted from cookpad.com where it is in daily use on Japan's
biggest Rails site.
...
Please take a look at https://github.com/cookpad/chanko_sample for example
usage.
